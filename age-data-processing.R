...
## Convert the age data to a long format to make it easier to work with.
...
## Calculate some central values to use in the situation where there is missing
## data as an imputed value so that we can return a value for every tract.
